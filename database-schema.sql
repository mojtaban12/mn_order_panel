...
CREATE TABLE IF NOT EXISTS `mn_orders` (
  ...
  `total_amount` DECIMAL(10,2) NOT NULL DEFAULT 0.00 COMMENT 'جمع کل (محصولات + حمل)',
  `shipping_cost` DECIMAL(10,2) NOT NULL DEFAULT 0.00 COMMENT 'هزینه حمل و نقل',
  `shipping_method` VARCHAR(255) NULL COMMENT 'روش حمل و نقل (عنوان)',
  `order_notes` TEXT,
